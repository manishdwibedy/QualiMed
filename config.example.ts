// INSTRUCTIONS:
// 1. Copy this file and rename the copy to `config.ts`.
// 2. Fill in your actual ALM credentials in the `config.ts` file.
// 3. IMPORTANT: Add `config.ts` to your `.gitignore` file to prevent committing secrets.
